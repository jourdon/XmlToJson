...
function xmlToArray($xml, $options = array()) {
        $defaults = array(
            ...
            'textContent' => 'local',       //key used for the text content of elements
    ...
    function parse_xml($xml)
    {
        ...
        return $this->normalize_xml(simplexml_load_string($xml, 'SimpleXMLElement', LIBXML_COMPACT | LIBXML_NOCDATA | LIBXML_NOBLANKS));
    }
    // 将 XML 解析之后的对象转成数组
